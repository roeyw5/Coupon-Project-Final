...
function AdminCreateCustomer(props) {
  const closeDiv = () => {
      ...
      <div className="AdminAddCustomer">
        <div className="AdminAddCustomer-close-div">
          <button
            className="btn-close"
            aria-label="Close"
            id="AdminAddCustomer-close-button"
            onClick={closeDiv}
            title="Close"
          ></button>
        </div>
        <h5 className="AdminAddCustomer-title" title="Create A New Customer">
            ...
            <Form>
              ...
              <div className="input-group">
                <div
                  ...
                  id="AdminAddCustomer-first_name-div"
                  title="Name"
                >
                  Name
                </div>
                <div className="input-group-text" title="First:">
                  First:
                </div>
                <Field
                ...
                />
                <div className="input-group-text" title="Last:">
                  Last:
                </div>
                <Field
              ...
              <div className="input-group">
                <div
                  className="input-group-text"
                  id="AdminAddCustomer-password-div"
                  title="Password"
                >
                  Password
                </div>

...
function CompanyUpdateCoupon(props) {
  let valid = true;
  let currentRef;
  let coupon;
  ...
  if (!props.values.checked[0]) {
    ...
    coupon = {
      ...
      image: currentRef.children[2].children[0].style.backgroundImage.slice(
        5,
        -2
      ),
      price: currentRef.children[6].children[0].innerHTML.substring(
        1,
        currentRef.children[6].children[0].innerHTML.length
      ),
  ...
  const handleSubmit = (values) => {
    CompanyService.updateCoupon(
      ...
      () => {
        setTimeout(() => {
          alert("The coupon was updated successfully.");
        }, 0);
        history.push("/company/my-coupons");
        ...
        try {
          if (error.response.data.response) {
            if (error.response.data.errorCode === "CPN-002.002")
              setTimeout(() => {
                alert(
                  'You already own a coupon with the title: "' +
                    values.title +
          ...
          <div className="CompanyUpdateCoupon">
            <div className="CompanyUpdateCoupon-close-div">
              <button
                className="btn-close"
                aria-label="Close"
                id="CompanyUpdateCoupon-close-button"
                onClick={closeDiv}
                title="Close"
              ></button>
            </div>
            <h5
              className="CompanyUpdateCoupon-title"
              title="Update An Existing Coupon"
            >
              ...
              {({ values, dirty }) => (
                <Form>
                  ...
                  <table className="CompanyUpdateCoupon-table">
                    <tbody>
                      <tr>
                        <th width="50%" title="From:">
                          From:
                        </th>
                        <th width="50%" title="To:">
                          To:
                        </th>
                      </tr>
                      <tr>
                        ...
                        <td>
                          ...
                          <div className="input-group">
                            ...
                            <div
                              ...
                              id="CompanyUpdateCoupon-title-div"
                              title="Title"
                            >
                              Title
                            </div>
                          ...
                          <div className="input-group">
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-description-div"
                              title="Description"
                            >
                              Description
                            </div>
                          ...
                          <div className="input-group">
                            <Field
                              ...
                              placeholder="-"
                              title={
                                coupon.category.charAt(0) +
                                coupon.category
                                  .toLowerCase()
                                  .substring(1, coupon.category.length)
                              }
                              value={
                                coupon.category.charAt(0) +
                                coupon.category
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-category-div"
                              title="Category"
                            >
                              Category
                            </div>
                          ...
                          <div className="input-group">
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-image-div"
                              title="Image URL"
                            >
                              Image URL
                            </div>
                          ...
                          <div className="input-group">
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-price-div"
                              title="Price"
                            >
                              Price
                            </div>
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-amount-div"
                              title="Amount"
                            >
                              Amount
                            </div>
                          ...
                          <div className="input-group">
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-from-div"
                              title="From:"
                            >
                              From:
                            </div>
                            <Field
                              ...
                              id="CompanyUpdateCoupon-from-input"
                            />
                            <div className="input-group-text" title="To:">
                              To:
                            </div>
                            <Field
                              type="date"
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-date-div"
                              title="Date"
                            >
                              Date
                            </div>
                        ...
                        <td>
                          ...
                          <div className="input-group">
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-to-price-div"
                              title="Price"
                            >
                              Price
                            </div>
                          ...
                          <div className="input-group">
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-to-left-div"
                              title="From:"
                            >
                              From:
                            </div>
                            ...
                            <div
                              className="input-group-text"
                              id="CompanyUpdateCoupon-end_date-div"
                              title="To"
                            >
                              To:
                            </div>
                  ...
                  <div className="CompanyUpdateCoupon-submit">
                    ...
                    <button
                      ...
                      id="CompanyUpdateCoupon-submit-button"
                      title="Update Coupon"
                      disabled={!dirty}
                    >
                      Update Coupon

...
function CompanyAddCoupon(props) {
  const closeDiv = () => {
  ...
  const handleSubmit = (values) => {
    CompanyService.createCoupon(
      ...
      () => {
        setTimeout(() => {
          alert("The coupon was created successfully.");
        }, 0);
        history.push("/company/my-coupons");
      ...
      <div className="CompanyAddCoupon">
        <div className="CompanyAddCoupon-close-div">
          <button
            className="btn-close"
            aria-label="Close"
            id="CompanyAddCoupon-close-button"
            onClick={closeDiv}
            title="Close"
          ></button>
        </div>
        <h5 className="CompanyAddCoupon-title" title="Add A New Coupon">
          Add A New Coupon
        </h5>
        <Formik
          initialValues={{
          ...
          {({ values }) => (
            <Form>
              ...
              <div className="input-group">
                <div
                  className="input-group-text"
                  id="CompanyAddCoupon-description-div"
                  title="Description"
                >
                  Description
                </div>
              ...
              <div className="input-group">
                <div
                  className="input-group-text"
                  id="CompanyAddCoupon-category-div"
                  title="Category"
                >
                  Category
                </div>
              ...
              <div className="input-group">
                ...
                />
                <div className="CompanyAddCoupon-div-seperator"></div>
                <div className="input-group-text" title="Amount">
                  Amount
                </div>
                <Field
                  type="number"
              ...
              <div className="input-group">
                <div
                  className="input-group-text"
                  id="CompanyAddCoupon-start_date-div"
                  title="Date"
                >
                  Date
                </div>
                <div className="input-group-text" title="From:">
                  From:
                </div>
                <Field
                  min={getToday()}
                ...
                <div
                  className="input-group-text"
                  id="CompanyAddCoupon-end_date-div"
                  title="To:"
                >
                  To:
                </div>

...
const AdminSidebar = lazy(() =>
  import("./user-sidebar/AdminSidebar/AdminSidebar")
);
const CompanySidebar = lazy(() =>
  import("./user-sidebar/CompanySidebar/CompanySidebar")
);
const CustomerSidebar = lazy(() =>
  import("./user-sidebar/CustomerSidebar/CustomerSidebar")
);

...
class CompanyService {
  ...
  async deleteCoupon(id) {
    return await axios.delete(
      "http://localhost:8080/company/delete-coupon?couponId=" + id
    );
  }
  ...
  async getCouponsCategory(category) {
    return await axios.get(
      "http://localhost:8080/company/get-coupons-category?category=" + category
    );
  }

  async getCouponsPrice(price) {
    return await axios.get(
      "http://localhost:8080/company/get-coupons-max-price?maxPrice=" + price
    );
  }
